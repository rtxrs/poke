...
let pvpBuffer: Buffer | null = null;
let pvpIndex: Map<string, number> = new Map(); // "SPECIES_FORM" -> offset
...
export function getRank(pokemonId: string, form: string | null | undefined, league: string, ivAttack: number, ivDefense: number, ivStamina: number): { rank: number } | null {
...
export function getRanks(): any[] { return []; }
